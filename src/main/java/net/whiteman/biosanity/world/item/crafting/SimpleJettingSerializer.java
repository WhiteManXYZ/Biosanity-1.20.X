...
public class SimpleJettingSerializer<T extends AbstractJettingRecipe> implements RecipeSerializer<T> {
    private final RecipeFactory<T> factory;

    public SimpleJettingSerializer(RecipeFactory<T> factory) {
