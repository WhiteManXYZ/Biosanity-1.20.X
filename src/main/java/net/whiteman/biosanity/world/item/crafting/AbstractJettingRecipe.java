...
public abstract class AbstractJettingRecipe implements Recipe<SimpleContainer> {
    ...
    public AbstractJettingRecipe(ResourceLocation id, ItemStack output, Ingredient input, ModifierType modifier, int time, DyeColor color) {
        this.id = id;
        this.output = output;
        this.input = input;
