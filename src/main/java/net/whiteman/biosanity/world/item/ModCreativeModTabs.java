package net.whiteman.biosanity.world.item;
    ...
    public static final RegistryObject<CreativeModeTab> biosanity_TAB = CREATIVE_MODE_TABS.register("biosanity_tab",
            () -> CreativeModeTab.builder().icon(() -> new ItemStack(ModItems.NEOPLASM_ROT.get()))
                    ...
                    .displayItems((pParameters, pOutput) -> {
                        ...
                        pOutput.accept(ModBlocks.NEOPLASM_ROT_BLOCK.get());
                        pOutput.accept(ModBlocks.NEOPLASM_VEIN_BLOCK.get());
                        pOutput.accept(ModBlocks.NEOPLASM_CORE_BLOCK.get());
                    })
                    .build());
