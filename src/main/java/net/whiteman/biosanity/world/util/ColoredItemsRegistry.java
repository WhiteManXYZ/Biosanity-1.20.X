package net.whiteman.biosanity.world.util;
...
public class ColoredItemsRegistry {
    ...
    public static List<Item> getListByFolder(String folder) {
        return switch (folder) {
            case "wool" -> ColoredItemsRegistry.WOOLS;
            case "wool_carpets" -> ColoredItemsRegistry.WOOL_CARPETS;
            case "glass" -> ColoredItemsRegistry.GLASS;
            case "glass_panes" -> ColoredItemsRegistry.GLASS_PANES;
            case "concrete_powder" -> ColoredItemsRegistry.CONCRETE_POWDER;
            case "concrete" -> ColoredItemsRegistry.CONCRETE;
            case "candle" -> ColoredItemsRegistry.CANDLE;
            case "terracotta" -> ColoredItemsRegistry.TERRACOTTA;
            case "shulkers" -> ColoredItemsRegistry.SHULKERS;
            case "beds" -> ColoredItemsRegistry.BEDS;
            case "banners" -> ColoredItemsRegistry.BANNERS;
            default -> List.of();
        };
    }
}